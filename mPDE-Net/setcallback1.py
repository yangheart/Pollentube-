...
class setcallback(object):
    ...
    def __call__(self, xopt, **args):
        ...
        self.ITERNUM += 1
        return None
    def saveloss(self, trainloss,testloss):
        """
        save loss
        ...
        try:
            os.mkdir(self.savepath+'/loss')
        except FileExistsError:
            pass
        filename = self.savepath+'/loss/'+str(self.stage)+'-xopt-'+".csv"
        d = {'trainloss':self.trainloss , 'Testloss': self.testloss}
